...
const new_profile_1 = new ModalBuilder({ custom_id: "new_profile_1", title: "New Character Profile (1/2)" }).addComponents(
...
const new_profile_2 = new ModalBuilder({ custom_id: "new_profile_2", title: "New Character Profile (2/2)" }).addComponents(
  new ActionRowBuilder({ components: [new TextInputBuilder({
...
export { new_profile_1, new_profile_2, edit_image };